...
val MIGRATION_1_2 = object : Migration(1, 2) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("INSERT INTO todo(title, notes, priority) VALUES('Sample','Sample notes',3)")
    }
}
val MIGRATION_2_3 = object : Migration(2, 3) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("INSERT INTO todo(title, notes, priority, is_done) VALUES('Sam','Coba',3,0)")
    }
}
